...
ALTER TABLE COMPANY ADD CONSTRAINT fk_1 FOREIGN KEY (COMPANY_ADDRESS_ID) references address(ADDRESS_ID);
ALTER TABLE COMPANY ADD CONSTRAINT fk_2 FOREIGN KEY (COMPANY_CONTACT_ID) references contact(CONTACT_ID);
